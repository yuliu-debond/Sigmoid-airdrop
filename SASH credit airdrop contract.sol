...
/**
 * @dev This is only an early draft of ERC659 interface, for latest version https://github.com/sgmfinance
 */
interface IERC659 {
...
contract ISASHCredit is IERC20 {
    // function burn(uint256 amount) public;
    // function burnFrom(address account, uint256 amount) public;
    ...
    // function mintERC659Bond6591Bond(address account, uint256 amount) internal ;
    // function getRedemptionPeriod(address account, uint256 amount) public view;
    
}
contract SASHCredit_Airdrop is IERC20, ISASHCredit, ERC20Detailed,  ERC20Burnable {

    constructor()

    ERC20Detailed("SASH credit", "SASH credit", 18)
  ...
  uint256 public constant event_end = 1619827200;// le 1 mai, 2021 labor's day ;>
  ...
  mapping (address=>bool) public withdrawClaimed;
    ...
    function startClaim()public returns (bool) {
        require(msg.sender == _dev_address,'Dev only.');
        require(now>=event_end, 'SASH Credit Airdrop: too early.');
